...
save(metadata_file, 'reports', 'success_count', 'frames', 'params', ...
    ...
    'pll_phase_compensation', ...
    'enable_cir_slow_phase_compensation', ...
    'cir_slow_phase_options', 'field_summary_file', ...
...
% Field-level A/B statistics use identical sample intervals for all three
...
sync_metrics = fieldSuppressionMetrics(observed, selected_model, ...
    selected_model_without_cir_slow, selected_model_without_pll, ...
    sync_indices);
...
function metrics = fieldSuppressionMetrics( ...
        observed, finalModel, modelWithoutCirSlow, modelWithoutPll, indices)
metrics = struct( ...
    'sample_count', 0, ...
    'suppression_db', NaN, ...
