...
switch params.sfd_mode
    case 'decawave'
        ...
        candidateSequences = {params.decawave_sfd(:)};
    case 'ieee'
        candidateNames = {'IEEE legacy/BPRF SFD #0'};
        candidateSequences = {params.ieee_sfd(:)};
    case '4z1'
        candidateNames = {'IEEE 802.15.4z SFD #1'};
        candidateSequences = {params.sfd4z_1(:)};
    case '4z2'
        candidateNames = {'IEEE 802.15.4z SFD #2'};
        candidateSequences = {params.sfd4z_2(:)};
    case '4z3'
        candidateNames = {'IEEE 802.15.4z SFD #3'};
        candidateSequences = {params.sfd4z_3(:)};
    case '4z4'
        candidateNames = {'IEEE 802.15.4z SFD #4'};
        candidateSequences = {params.sfd4z_4(:)};
    case 'auto'
        candidateNames = {'Decawave DW-8', ...
