...
assertSmoke(ismember(r.dw_search_path, ...
    ["qm35_neighborhood", "late_after_qm35"]), ...
    sprintf('pkt24 search_path %s not neighborhood/late_after_qm35.', ...
...
assertSmoke(ismember(r.dw_search_path, ...
    ["qm35_neighborhood", "late_after_qm35"]), ...
    sprintf('pkt5 search_path %s not neighborhood/late_after_qm35.', ...
        char(r.dw_search_path)));
