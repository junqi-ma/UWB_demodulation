...
%% 1. Load QM35 results, or configure a fresh DW1000 decode
if strcmpi(device_profile, 'qm35')
    saved = load(saved_result_file, ...
        'result', 'tx', 'tx_after_cir', 'options');
    result = saved.result;
    tx = saved.tx;
    tx_after_cir = saved.tx_after_cir;
...
%% 2b. Decode and reconstruct DW1000 using its actual PHY parameters
if strcmpi(device_profile, 'dw1000')
    ...
    fprintf('DW1000 reconstructed result: %s\n', saved_result_file);
end
